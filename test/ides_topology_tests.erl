...
one_for_one_topology_test_() ->
    Children = [
        #{id => my_server, start => {ides_test_sup, start_child, []},
          restart => permanent, shutdown => 5000, type => worker, modules => [ides_test_sup]},
        #{id => my_statem, start => {ides_test_sup, start_child, []},
...
one_for_all_topology_test_() ->
    Children = [
        #{id => worker_1, start => {ides_test_sup, start_child, []},
          restart => permanent, shutdown => 5000, type => worker, modules => [ides_test_sup]},
        #{id => worker_2, start => {ides_test_sup, start_child, []},
          restart => permanent, shutdown => 5000, type => worker, modules => [ides_test_sup]},
        #{id => cache, start => {ides_test_sup, start_child, []},
...
rest_for_one_topology_test_() ->
    Children = [
        #{id => startup, start => {ides_test_sup, start_child, []},
          restart => permanent, shutdown => 5000, type => worker, modules => [ides_test_sup]},
        #{id => process, start => {ides_test_sup, start_child, []},
          restart => permanent, shutdown => 5000, type => worker, modules => [ides_test_sup]},
        #{id => cleanup, start => {ides_test_sup, start_child, []},
          restart => permanent, shutdown => 5000, type => worker, modules => [ides_test_sup]}
    ],
...
simple_one_for_one_topology_test_() ->
    ChildTemplate = #{id => handler, start => {ides_test_sup, start_child, []},
                      restart => permanent, shutdown => 5000, type => worker, modules => [ides_test_sup]},
    {setup,
     fun() ->
